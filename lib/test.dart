        ...
        builder: (context, AsyncSnapshot snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            if (snapshot.data == null) {
              ...
              File? file = File(
                  snapshot.data.path); // XFileyi File formatına dönüştürdüm.
              print(Image.memory(
                  base64Decode((base64Encode(file.readAsBytesSync())))));

              //File? file2 = File(snapshot.data.path);
              Utilty.saveImageToPreferences(Utilty.base64String(file
                  .readAsBytesSync())); // bu ikisi shared preferences ile ilgili
