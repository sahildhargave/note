...
class NavigationDrawerWidget extends StatelessWidget {
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      noteBloc.add(TumNotlarEvent(
                          categoryId: StaticValues.currentCategoryId));
                      StaticValues.currentEvent = TumNotlarEvent(
                          categoryId: StaticValues.currentCategoryId);
                  ...
                  ListTile(
                      onTap: () {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (conext) => DeletedNotesPage()));
                        scaffoldKey.currentState!.closeDrawer();
                      },
                      leading: Icon(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("get_categories".tr,
                            style: TextStyle(
                                color: Color(0x94000000), fontSize: 13)),
                        Obx(
                          () => IconButton(
                              onPressed: () {
                                getxController.isCategoryEditing.value =
                                    !getxController.isCategoryEditing.value;
                              },
                              icon: getxController.isCategoryEditing.value ==
                                      false
                                  ? Icon(
                                      Icons.edit,
                                      size: 18,
                  ...
                  for (var category in state.Categories)
                    GestureDetector(
                      onTap: () {
                        ...
                        StaticValues.currentCategoryName =
                                          ...
                                          Expanded(
                                            child: DialogButton(
                                              onPressed: () async {
                                                ...
                                                StaticValues.currentCategoryId =
                                                    -1;
                                                ...
                                                StaticValues
                                                        .currentCategoryName =
                                                    "get_allnotes".tr;
                                                getxController.isCategoryEditing
                                                    .value = false;
                                                StaticValues.currentEvent =
                                                    TumNotlarEvent(
                                                        categoryId: -1);
                                                noteBloc.add(TumNotlarEvent(
                                                    categoryId: -1));
                            ...
                            DialogButton(
                              onPressed: () {
                                if (addCategoryTextController.text != "") {
                                  noteDatabaseHelper.insertCategory(
  ...
  Widget buildMenuItem({required String text}) {
    return Obx(
      () => ListTile(
          leading: SizedBox(
              height: 20, child: Image.asset("assets/images/arrow.png")),
          title: Text(
            text,
            style: TextStyle(
                color: Color(0xff006687),
          ...
          trailing: getxController.isCategoryEditing == true
              ? Checkbox(
