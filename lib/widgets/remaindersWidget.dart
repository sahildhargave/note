                      ...
                      for (var remainder in getxController.remainders)
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: DateTime.parse(remainder.date.toString())
                          ...
                          child: Row(
                            children: [
                              DateTime.parse(remainder.date.toString())
                                      .isBefore(DateTime.now())
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    "${remainder.date.toString().substring(0, 11).replaceAll("-", "/")}",
                                    style: TextStyle(fontSize: 12),
                                  ),
                                  Text(
                                      "${remainder.date.toString().substring(11, 16)}"),
                                ],
                              ),
                              SizedBox(
                                width: 10,
                    ...
                    children: [
                      for (var date in getxController.newNoteRemainders)
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(15),
                            color: DateTime.parse(date).isBefore(DateTime.now())
                                ? Color(0x4affaa00)
                                : Color(0xffffaa00),
                          ),
                          child: Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    "${date.substring(0, 11).replaceAll("-", "/")}",
                                    style: TextStyle(fontSize: 12),
                                  ),
