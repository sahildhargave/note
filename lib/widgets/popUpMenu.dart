  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton<int>(
      ...
      itemBuilder: (context) => [
        PopupMenuItem(
          value: 1,
          child: StaticValues.lockstate != 1
              ? Row(
                  children: [
              ...
              : Row(
                  children: [
                    Icon(Icons.lock_open_rounded, color: Color(0xff036300)),
                    SizedBox(
                      width: 10,
                    ),
                    Text("get_removelock".tr,
                        style: TextStyle(color: Colors.black))
                  ],
                ),
        ),
                    ...
                    onPressed: () async {
                      ...
                      if (passwordEditTextControllerAdd.text.length == 4) {
                        await sharedPreferences.setString(
                            "password", passwordEditTextControllerAdd.text);
                        Get.snackbar(
                      ...
                      children: [
                        Expanded(
                          child: DialogButton(
                            onPressed: () async {
                              await notedbHelper
                                  .moveNotesToTrash([widget.noteId!]);
