    ...
    return multiSelectionMode == true
        ? Container(
            ...
            decoration: Get.isDarkMode
                ? BoxDecoration(color: Color(0xff383838))
                : BoxDecoration(
                                    ...
                                    child: DialogButton(
                                      onPressed: () async {
                                        await noteDatabaseHelper
                                            .moveNotesToTrash(selectedItems);
                                        setState(() {
                                          selectedItems.clear();
                                          multiSelectionMode = false;
                                        });
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color:
                        Get.isDarkMode ? Color(0xff383838) : Color(0xffe7f0f8),
                    border: isSearching
                        ? Border.all(color: Color(0xff006c8d), width: 2)
                        : null,
                  ),
                  child: Row(
                    children: [
