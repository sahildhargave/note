...
class _TaskCardWidgetState extends State<TaskCardWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    String lightColor =
        "${widget.task2.color!.substring(0, 2)}4C${widget.task2.color!.substring(4)}";
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  widget.task2.description ??
                                      "get_nodescription".tr,
                                  style: const TextStyle(
                  ...
                  if (isEditing == true)
                    Row(
                      ...
                      children: [
                                    ...
                                    onSubmitted: (value) async {
                                      if (value != "") {
                                        if (widget.task2.id == null) {
                                          int lastTaskId2 =
                                              StaticValues.lastTaskId;
                                          Task taskModel = Task(
                                              id: null,
                                              title: value,
                                              color: StaticValues
                                                  .colorList[lastTaskId2 % 6]);

                                          await dbHelper.insertTask(taskModel);
                                        } else {
                                          await dbHelper.updateTaskTitle(
                                              widget.task2.id!, value);
                                        }
                                      }
                        ...
                        IconButton(
                          onPressed: () async {
                            String titleEditTextValue =
                                titleEditTextController.text;
                            String descEditTextValue =
                            ...
                            if (titleEditTextValue != "") {
                              if (widget.task2.id == null) {
                                ...
                                await dbHelper.updateTaskTitle(
                                    widget.task2.id!, titleEditTextValue);
                                await dbHelper.updateTaskDescription(
                                    widget.task2.id!, descEditTextValue);
                                taskBloc.add(TumTasklarEvent());
                                isEditing = false;
                              }
                            } else {
              ...
              if (state is TaskListState2) {
                return Visibility(
                    ...
                    child: AnimatedContainer(
                        ...
                        height: (todoList.length).toDouble() * 50 + 50 > 275
                            ? 275
                            : (todoList.length).toDouble() * 50 + 50,
                        child: Column(
                          children: [
                            Padding(
