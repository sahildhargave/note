...
class _NoteMainPageState extends State<NoteMainPage> {
  ...
  Future<void> loadFontSize() async {
    ...
    setState(() {
      controller.fontSizeSlider.value = dbFontSize;
    });
  }
  ...
  Widget buildNoteTile(
      BuildContext context, Note note, String content, int index) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (note.isFavourite == 1) buildFavoriteIcon(),
              ],
            ),
          ),
        ),
