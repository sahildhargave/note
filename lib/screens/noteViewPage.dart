...
class _NoteViewPageState extends State<NoteViewPage> {
  ...
  Future<String> saveImageToLocal(bool isGallery) async {
    ...
    if (imageFile2 != null) {
      final Directory duplicateFileDir =
    ...
    return SafeArea(
      child: WillPopScope(
        ...
        child: Scaffold(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        CategoriesPopUpMenu(),
                        Spacer(),
                        FavoriteStar(widget.indexOfNote == null
                            ? -1
                            : widget.indexOfNote!),
                        EnesPopUpMenu(
                          lockState: widget.note.isLocked,
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        children: [
                          ...
                          if (widget.indexOfNote == null) remaindersWidget(),
                                ...
                                child: SizedBox(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      IconButton(
                                          onPressed: () {
                                            getxController.addingTask.value =
                                                false;
                                          },
                                          icon: Icon(
                                            Icons.close_rounded,
                          ...
                          if (widget.indexOfNote != null)
                            noteTodoWidget(
                              indexOfNote: widget.indexOfNote,
                            ),
                          if (widget.indexOfNote == null) noteTodoWidget(),
                          ...
                          Obx(
                            () => TextField(
                              ...
                              style: TextStyle(
                                fontSize:
                                    controller.fontSizeSlider.value.toDouble(),
                                color: Get.isDarkMode
                                    ? Color(0xfff8f8f8)
                                    : Colors.black,
                                fontFamily: 'Quicksand',
          ...
          floatingActionButton: CircularMenuWidget(onGalleryImage: () {
            if (widget.note.noteId == null) {
            ...
            Alert(
                ...
                buttons: [
                  DialogButton(
                    onPressed: () async {
                      if (hasDateSelected == true &&
                          getxController.hasDatePast == false) {
                        if (widget.indexOfNote != null) {
                          ...
                          Navigator.pop(context);
                          Get.snackbar("get_remaindercreated".tr, "",
                              backgroundColor: Color(0x88006c8d),
                              colorText: Colors.white,
                              duration: Duration(milliseconds: 1500));
                        } else {
                          Navigator.pop(context);
                          getxController.newNoteRemainders
                              .add(selectedDate.toString());
                        }
                      } else {
                        Get.snackbar("get_remaindernotcreated".tr,
                            "get_youselectedpastdate".tr,
                            backgroundColor: Color(0x88006c8d),
                            colorText: Colors.white,
                            duration: Duration(milliseconds: 1500));
                      }
