//👧👦Setting like font and theme dark and light normal mode🧒👶
        ...
        () => ListView(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "get_password".tr,
                style: TextStyle(color: Color(0xff006c8d), fontSize: 16),
              ),
            ),
                ...
                onTap: () async {
                  ...
                  Alert(
                      ...
                      buttons: [
                        DialogButton(
                          onPressed: () async {
                            if (passwordEditTextControllerAdd.text.length ==
                                4) {
                              await sharedPreferences.setString("password",
                                  passwordEditTextControllerAdd.text);
                              Get.snackbar(
                                "get_passwordadded".tr,
                                "",
                                backgroundColor: Color(0x74006c8d),
              ...
              Column(
                children: [
                  ListTile(
                    ...
                    title: Text("get_changepassword".tr,
                        style: TextStyle(
                          fontSize: 18,
                        )),
                  ),
                    ...
                    onTap: () async {
                      ...
                      screenLock(
                          ...
                          didUnlocked: () async {
                            ...
                            Get.off(() => SettingsPage());
                            Get.snackbar(
                              "get_passwordremoved".tr,
                              "",
                              backgroundColor: const Color(0x74006c8d),
                              colorText: Colors.white,
                            );
                            getxController.hasPassword.value = false;
                          });
                    },
                    title: Text("get_removepassword".tr,
                        style: TextStyle(
                          fontSize: 18,
                        )),
              ...
              onTap: () async {
                ...
                Alert(
                      ...
                      children: <Widget>[
                        Obx(
                          () => Slider(
                            ...
                            min: 12,
                            divisions: 6,
                            label: getxController.fontSizeSlider.value
                                .round()
                                .toString(),
                    ...
                    buttons: [
                      DialogButton(
                        onPressed: () async {
                          noteDatabaseHelper.setFontsize(
                              fontSize: getxController.fontSizeSlider.value);
                          Get.back();
                        },
                        child: Text(
                          "get_change".tr,
