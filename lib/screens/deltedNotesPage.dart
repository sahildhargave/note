...
class _DeletedNotesPageState extends State<DeletedNotesPage> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: Get.isDarkMode ? Color(0xffffe300) : Color(0xff720000)),
        ),
        child: Row(
          children: [
            Text("get_emptytrash".tr,
                style: TextStyle(
  ...
  Widget _buildNoteCard(Note note, int index) {
    final content = note.noteContent!.length > 150
    ...
    screenLock(
      ...
      didUnlocked: () {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (context) => DeletedNotesViewPage(note, index)));
